...
- 文稿：`docs/zh-CN/chapters/43-codable-persistence-and-local-cache.md`
- 示例项目：`demos/projects/43-codable-persistence-and-local-cache`
...
- 直接把 DTO 当缓存文件结构，导致远程字段变化立刻把本地边界也搅乱
- 只判断“有没有缓存文件”，却不区分命中、缺失和损坏
- 把快照缓存误用成“本地数据库”
